...
export const EMPTY_TABS = {
    ...
    important: { 
        heading: 'No important messages',
        subHeading: "Stars let you give messages a important status to make them easier to find. To imporrtant a message, click on the imporrtant outline beside any message or conversation."
    },
    sent: {
